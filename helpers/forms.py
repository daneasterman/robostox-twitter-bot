FORMS = {
	"10-Q": "Form 10-Q is the quarterly report for the company. The form includes details on profit/loss, the balance sheet and cash flow.",
	"10-K": "Form 10-K is the annual financial report for the company.",
	...
	"8-K": "Form 8-K reports on any major unscheduled event including hiring/firing executives, resignations, merger/acquisitions, etc.",
